<div class="sidebar hidden sm:block w-0 sm:w-1/6 bg-gray-200 h-screen shadow fixed top-0 left-0 bottom-0 z-40 overflow-y-auto">
    <div class="mb-6 mt-20 px-6">
        <a href="<?php echo e(route('home')); ?>" class="flex items-center text-gray-600 py-2 hover:text-blue-700">
        ...
        <a href="<?php echo e(route('classes.index')); ?>" class="flex items-center text-gray-600 py-2 hover:text-blue-700">
        ...
        <a href="<?php echo e(route('parents.index')); ?>" class="flex items-center text-gray-600 py-2 hover:text-blue-700">
        ...
        <a href="<?php echo e(route('student.index')); ?>" class="flex items-center text-gray-600 py-2 hover:text-blue-700">
            ...
            <span class="ml-2 text-sm font-semibold">Emergency</span>
        </a>
       
        <a href="<?php echo e(route('assignrole.index')); ?>" class="flex items-center text-gray-600 py-2 hover:text-blue-700">
...
</div><?php /**PATH C:\xampp\htdocs\AMS-LARAVEL\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>